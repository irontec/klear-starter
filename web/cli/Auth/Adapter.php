...
class {appnamespace}_Auth_Adapter implements \Klear_Auth_Adapter_KlearAuthInterface
{
    ...
    )
    {
        ...
        if (!$this->_userMapper instanceof Klear_Auth_Adapter_Interfaces_BasicUserMapper) {
            throw new \Exception(
                'Auth userMapper must implement Klear_Auth_Adapter_BasicUserInterface'
            );
        }
    ...
    protected function _userHasValidCredentials(
        Klear_Auth_Adapter_Interfaces_BasicUserModel $user = null
    )
    {
    ...
    public function saveStorage()
    {
        ...
        $this->_user->login  = $this->_user->getLogin();
        $this->_user->fullName  = $this->_user->getFullName();
